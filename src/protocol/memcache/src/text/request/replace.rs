...
impl TextProtocol {
    ...
    pub fn parse_replace_request<'a>(&self, input: &'a [u8]) -> IResult<&'a [u8], Replace> {
    ...
    pub(crate) fn _compose_replace_request(
        &self,
        request: &Replace,
...
mod tests {
    ...
    fn parse() {
        ...
        assert_eq!(
            protocol._parse_request(b"replace 0 0 0 1\r\n0\r\n"),
            Ok((
                &b""[..],
        ...
        // noreply
        assert_eq!(
            protocol._parse_request(b"replace 0 0 0 1 noreply\r\n0\r\n"),
            Ok((
                &b""[..],
                Request::Replace(Replace {
                    key: b"0".to_vec().into_boxed_slice(),
